...
public class RedTeleOp extends OpMode {
    ...
    public static Pose startingPose =  new Pose(144-48, 72, Math.toRadians(180-125));
    ...
    private final double offset = Math.toRadians(0.0);
    ...
    public void init() {
        ...
        robotHeading = new RobotHeading(follower, 144, 144);
