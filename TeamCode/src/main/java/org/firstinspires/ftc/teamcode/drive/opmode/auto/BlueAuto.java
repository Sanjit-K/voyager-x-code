...
public class BlueAuto extends LinearOpMode {
        ...
        switch (pathStatePPG) {
            ...
            case 4: // Intakes ball no 3, stops servos when ball reaches color sensor
                ...
                if (runtime.seconds() > 8.8) {
                    presetLaunch(500); // Shoots ball no 3
                    setpathState(5);
                }
                break;
            ...
            case 9: // Shoot balls no 4 and 5
                if (runtime.seconds() > 18 && !follower.isBusy()){
                    launchServos.enable();
                    intakeServos.enableFrontIntake();
                    setpathState(10);
                }
            ...
            case 14: // Shoots ball no 6 and 7
                if (runtime.seconds() > 28 && !follower.isBusy()){
                    launchServos.enable();
                    intakeServos.enableFrontIntake();
                    setpathState(15);
                }
    ...
    private void path3(){
        ...
        PathChain scorePPG = follower.pathBuilder()
                .addPath(new BezierLine(new Pose(20, 35.5, Math.toRadians(180)), new Pose(48, 48, Math.toRadians(180+112))))
                .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180+112))
                .build();
    ...
    private void path4(){
        ...
        PathChain scorePGP = follower.pathBuilder()
                .addPath(new BezierLine(new Pose(48, 48, Math.toRadians(180+112)), PGPPose))
                .setLinearHeadingInterpolation(Math.toRadians(180+112), PGPPose.getHeading())
                .build();
    ...
    private void path6(){
        follower.setMaxPower(0.5);
        PathChain scorePGP = follower.pathBuilder()
                .addPath(new BezierLine(new Pose(20, 59.5, Math.toRadians(180)), new Pose(48, 72, Math.toRadians(180+122))))
                .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180+122))
                .build();
        follower.followPath(scorePGP);
    }
}